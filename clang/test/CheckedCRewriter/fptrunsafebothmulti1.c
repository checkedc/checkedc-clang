// RUN: cconv-standalone -base-dir=%S -output-postfix=checked %s %S/fptrunsafebothmulti2.c
//RUN: %clang -c %S/fptrunsafebothmulti1.checked.c %S/fptrunsafebothmulti2.checked.c
