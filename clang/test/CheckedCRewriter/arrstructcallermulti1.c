// RUN: cconv-standalone -base-dir=%S -output-postfix=checked %s %S/arrstructcallermulti2.c
//RUN: %clang -c %S/arrstructcallermulti1.checked.c %S/arrstructcallermulti2.checked.c
