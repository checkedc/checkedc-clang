// RUN: cconv-standalone -base-dir=%S -output-postfix=checked %s %S/fptrinstructbothmulti2.c
//RUN: %clang -c %S/fptrinstructbothmulti1.checked.c %S/fptrinstructbothmulti2.checked.c
