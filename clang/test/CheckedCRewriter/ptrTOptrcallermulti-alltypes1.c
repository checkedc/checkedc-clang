// RUN: cconv-standalone -base-dir=%S -alltypes -output-postfix=checked %s %S/ptrTOptrcallermulti-alltypes2.c
//RUN: FileCheck -match-full-lines --input-file %S/ptrTOptrcallermulti-alltypes1.checked.c %s
//RUN: rm %S/ptrTOptrcallermulti-alltypes1.checked.c %S/ptrTOptrcallermulti-alltypes2.checked.c
