// RUN: cconv-standalone -base-dir=%S -alltypes -output-postfix=checked2 %s %S/fptrsafecallermulti-alltypes1.c
//RUN: FileCheck -match-full-lines --input-file %S/fptrsafecallermulti-alltypes2.checked2.c %s
//RUN: rm %S/fptrsafecallermulti-alltypes1.checked2.c %S/fptrsafecallermulti-alltypes2.checked2.c
...
/*For robustness, this test is identical to fptrsafeprotocaller-alltypes.c and fptrsafecaller-alltypes.c except in that
