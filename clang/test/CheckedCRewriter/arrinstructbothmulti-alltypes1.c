// RUN: cconv-standalone -base-dir=%S -alltypes -output-postfix=checked %s %S/arrinstructbothmulti-alltypes2.c
//RUN: FileCheck -match-full-lines --input-file %S/arrinstructbothmulti-alltypes1.checked.c %s
//RUN: rm %S/arrinstructbothmulti-alltypes1.checked.c %S/arrinstructbothmulti-alltypes2.checked.c
...
/*For robustness, this test is identical to arrinstructprotoboth-alltypes.c and arrinstructboth-alltypes.c except in that
