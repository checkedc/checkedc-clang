// RUN: cconv-standalone -base-dir=%S -alltypes -output-postfix=checked2 %s %S/safefptrargcallermulti-alltypes1.c
//RUN: FileCheck -match-full-lines --input-file %S/safefptrargcallermulti-alltypes2.checked2.c %s
//RUN: rm %S/safefptrargcallermulti-alltypes1.checked2.c %S/safefptrargcallermulti-alltypes2.checked2.c
...
/*For robustness, this test is identical to safefptrargprotocaller-alltypes.c and safefptrargcaller-alltypes.c except in that
