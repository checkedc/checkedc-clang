// RUN: cconv-standalone -base-dir=%S -alltypes -output-postfix=checked %s %S/fptrsafecalleemulti-alltypes2.c
//RUN: FileCheck -match-full-lines --input-file %S/fptrsafecalleemulti-alltypes1.checked.c %s
//RUN: rm %S/fptrsafecalleemulti-alltypes1.checked.c %S/fptrsafecalleemulti-alltypes2.checked.c
