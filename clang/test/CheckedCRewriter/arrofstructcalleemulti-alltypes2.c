// RUN: cconv-standalone -base-dir=%S -alltypes -output-postfix=checked2 %s %S/arrofstructcalleemulti-alltypes1.c
//RUN: FileCheck -match-full-lines --input-file %S/arrofstructcalleemulti-alltypes2.checked2.c %s
//RUN: rm %S/arrofstructcalleemulti-alltypes1.checked2.c %S/arrofstructcalleemulti-alltypes2.checked2.c
...
of structs*/
/*For robustness, this test is identical to arrofstructprotocallee-alltypes.c and arrofstructcallee-alltypes.c except in that
