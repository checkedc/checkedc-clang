// RUN: cconv-standalone -base-dir=%S -alltypes -output-postfix=checked %s %S/arrofstructcalleemulti-alltypes2.c
//RUN: FileCheck -match-full-lines --input-file %S/arrofstructcalleemulti-alltypes1.checked.c %s
//RUN: rm %S/arrofstructcalleemulti-alltypes1.checked.c %S/arrofstructcalleemulti-alltypes2.checked.c
