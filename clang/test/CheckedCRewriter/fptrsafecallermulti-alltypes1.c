// RUN: cconv-standalone -base-dir=%S -alltypes -output-postfix=checked %s %S/fptrsafecallermulti-alltypes2.c
//RUN: FileCheck -match-full-lines --input-file %S/fptrsafecallermulti-alltypes1.checked.c %s
//RUN: rm %S/fptrsafecallermulti-alltypes1.checked.c %S/fptrsafecallermulti-alltypes2.checked.c
