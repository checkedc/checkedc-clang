// RUN: cconv-standalone -base-dir=%S -alltypes -output-postfix=checked2 %s %S/safefptrargsafemulti-alltypes1.c
//RUN: FileCheck -match-full-lines --input-file %S/safefptrargsafemulti-alltypes2.checked2.c %s
//RUN: rm %S/safefptrargsafemulti-alltypes1.checked2.c %S/safefptrargsafemulti-alltypes2.checked2.c
...
/*For robustness, this test is identical to safefptrargprotosafe-alltypes.c and safefptrargsafe-alltypes.c except in that
