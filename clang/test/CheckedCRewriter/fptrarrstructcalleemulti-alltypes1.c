// RUN: cconv-standalone -base-dir=%S -alltypes -output-postfix=checked %s %S/fptrarrstructcalleemulti-alltypes2.c
//RUN: FileCheck -match-full-lines --input-file %S/fptrarrstructcalleemulti-alltypes1.checked.c %s
//RUN: rm %S/fptrarrstructcalleemulti-alltypes1.checked.c %S/fptrarrstructcalleemulti-alltypes2.checked.c
