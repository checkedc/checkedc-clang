// RUN: cconv-standalone -base-dir=%S -alltypes -output-postfix=checked2 %s %S/ptrTOptrbothmulti-alltypes1.c
//RUN: FileCheck -match-full-lines --input-file %S/ptrTOptrbothmulti-alltypes2.checked2.c %s
//RUN: rm %S/ptrTOptrbothmulti-alltypes1.checked2.c %S/ptrTOptrbothmulti-alltypes2.checked2.c
...
/*For robustness, this test is identical to ptrTOptrprotoboth-alltypes.c and ptrTOptrboth-alltypes.c except in that
