// RUN: cconv-standalone -base-dir=%S -alltypes -output-postfix=checked2 %s %S/fptrarrstructcalleemulti-alltypes1.c
//RUN: FileCheck -match-full-lines --input-file %S/fptrarrstructcalleemulti-alltypes2.checked2.c %s
//RUN: rm %S/fptrarrstructcalleemulti-alltypes1.checked2.c %S/fptrarrstructcalleemulti-alltypes2.checked2.c
...
/*For robustness, this test is identical to fptrarrstructprotocallee-alltypes.c and fptrarrstructcallee-alltypes.c except in that
