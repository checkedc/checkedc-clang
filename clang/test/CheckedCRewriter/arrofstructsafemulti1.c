// RUN: cconv-standalone -base-dir=%S -output-postfix=checked %s %S/arrofstructsafemulti2.c
//RUN: %clang -c %S/arrofstructsafemulti1.checked.c %S/arrofstructsafemulti2.checked.c
