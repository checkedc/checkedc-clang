...
//RUN: %clang -c %S/fptrinstructprotocaller.checkedNOALL.c
//RUN: rm %S/fptrinstructprotocaller.checkedNOALL.c
...
/*For robustness, this test is identical to fptrinstructcaller.c except in that
