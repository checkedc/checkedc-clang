// RUN: cconv-standalone -base-dir=%S -alltypes -output-postfix=checked %s %S/arrstructcalleemulti-alltypes2.c
//RUN: FileCheck -match-full-lines --input-file %S/arrstructcalleemulti-alltypes1.checked.c %s
//RUN: rm %S/arrstructcalleemulti-alltypes1.checked.c %S/arrstructcalleemulti-alltypes2.checked.c
...
/*For robustness, this test is identical to arrstructprotocallee-alltypes.c and arrstructcallee-alltypes.c except in that
