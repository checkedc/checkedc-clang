// RUN: cconv-standalone -base-dir=%S -alltypes -output-postfix=checked2 %s %S/fptrarrstructbothmulti-alltypes1.c
//RUN: FileCheck -match-full-lines --input-file %S/fptrarrstructbothmulti-alltypes2.checked2.c %s
//RUN: rm %S/fptrarrstructbothmulti-alltypes1.checked2.c %S/fptrarrstructbothmulti-alltypes2.checked2.c
