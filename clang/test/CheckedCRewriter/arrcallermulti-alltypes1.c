// RUN: cconv-standalone -base-dir=%S -alltypes -output-postfix=checked %s %S/arrcallermulti-alltypes2.c
//RUN: FileCheck -match-full-lines --input-file %S/arrcallermulti-alltypes1.checked.c %s
//RUN: rm %S/arrcallermulti-alltypes1.checked.c %S/arrcallermulti-alltypes2.checked.c
