// RUN: cconv-standalone -base-dir=%S -alltypes -output-postfix=checked2 %s %S/arrinstructcalleemulti-alltypes1.c
//RUN: FileCheck -match-full-lines --input-file %S/arrinstructcalleemulti-alltypes2.checked2.c %s
//RUN: rm %S/arrinstructcalleemulti-alltypes1.checked2.c %S/arrinstructcalleemulti-alltypes2.checked2.c
