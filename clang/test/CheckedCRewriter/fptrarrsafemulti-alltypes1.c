// RUN: cconv-standalone -base-dir=%S -alltypes -output-postfix=checked %s %S/fptrarrsafemulti-alltypes2.c
//RUN: FileCheck -match-full-lines --input-file %S/fptrarrsafemulti-alltypes1.checked.c %s
//RUN: rm %S/fptrarrsafemulti-alltypes1.checked.c %S/fptrarrsafemulti-alltypes2.checked.c
