// RUN: cconv-standalone -base-dir=%S -alltypes -output-postfix=checked2 %s %S/fptrsafebothmulti-alltypes1.c
//RUN: FileCheck -match-full-lines --input-file %S/fptrsafebothmulti-alltypes2.checked2.c %s
//RUN: rm %S/fptrsafebothmulti-alltypes1.checked2.c %S/fptrsafebothmulti-alltypes2.checked2.c
...
/*For robustness, this test is identical to fptrsafeprotoboth-alltypes.c and fptrsafeboth-alltypes.c except in that
