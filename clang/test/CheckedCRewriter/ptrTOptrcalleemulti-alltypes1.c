// RUN: cconv-standalone -base-dir=%S -alltypes -output-postfix=checked %s %S/ptrTOptrcalleemulti-alltypes2.c
//RUN: FileCheck -match-full-lines --input-file %S/ptrTOptrcalleemulti-alltypes1.checked.c %s
//RUN: rm %S/ptrTOptrcalleemulti-alltypes1.checked.c %S/ptrTOptrcalleemulti-alltypes2.checked.c
