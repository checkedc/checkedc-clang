// RUN: cconv-standalone -base-dir=%S -alltypes -output-postfix=checked2 %s %S/arrsafemulti-alltypes1.c
//RUN: FileCheck -match-full-lines --input-file %S/arrsafemulti-alltypes2.checked2.c %s
//RUN: rm %S/arrsafemulti-alltypes1.checked2.c %S/arrsafemulti-alltypes2.checked2.c
