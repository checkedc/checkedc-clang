// RUN: cconv-standalone -base-dir=%S -output-postfix=checked %s %S/fptrsafesafemulti2.c
//RUN: %clang -c %S/fptrsafesafemulti1.checked.c %S/fptrsafesafemulti2.checked.c
