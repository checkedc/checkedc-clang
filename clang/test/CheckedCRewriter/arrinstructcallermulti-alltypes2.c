// RUN: cconv-standalone -base-dir=%S -alltypes -output-postfix=checked2 %s %S/arrinstructcallermulti-alltypes1.c
//RUN: FileCheck -match-full-lines --input-file %S/arrinstructcallermulti-alltypes2.checked2.c %s
//RUN: rm %S/arrinstructcallermulti-alltypes1.checked2.c %S/arrinstructcallermulti-alltypes2.checked2.c
