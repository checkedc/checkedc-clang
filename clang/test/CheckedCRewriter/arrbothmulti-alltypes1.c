// RUN: cconv-standalone -base-dir=%S -alltypes -output-postfix=checked %s %S/arrbothmulti-alltypes2.c
//RUN: FileCheck -match-full-lines --input-file %S/arrbothmulti-alltypes1.checked.c %s
//RUN: rm %S/arrbothmulti-alltypes1.checked.c %S/arrbothmulti-alltypes2.checked.c
