// RUN: cconv-standalone -base-dir=%S -output-postfix=checked %s %S/arrofstructcalleemulti2.c
//RUN: %clang -c %S/arrofstructcalleemulti1.checked.c %S/arrofstructcalleemulti2.checked.c
