// RUN: cconv-standalone -base-dir=%S -alltypes -output-postfix=checked %s %S/arrofstructcallermulti-alltypes2.c
//RUN: FileCheck -match-full-lines --input-file %S/arrofstructcallermulti-alltypes1.checked.c %s
//RUN: rm %S/arrofstructcallermulti-alltypes1.checked.c %S/arrofstructcallermulti-alltypes2.checked.c
