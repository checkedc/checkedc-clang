// RUN: cconv-standalone -base-dir=%S -alltypes -output-postfix=checked %s %S/fptrarrstructsafemulti-alltypes2.c
//RUN: FileCheck -match-full-lines --input-file %S/fptrarrstructsafemulti-alltypes1.checked.c %s
//RUN: rm %S/fptrarrstructsafemulti-alltypes1.checked.c %S/fptrarrstructsafemulti-alltypes2.checked.c
