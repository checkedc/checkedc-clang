// RUN: cconv-standalone -base-dir=%S -output-postfix=checked %s %S/fptrinstructcallermulti2.c
//RUN: %clang -c %S/fptrinstructcallermulti1.checked.c %S/fptrinstructcallermulti2.checked.c
