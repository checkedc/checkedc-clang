// RUN: cconv-standalone -base-dir=%S -output-postfix=checked %s %S/fptrinstructcalleemulti2.c
//RUN: %clang -c %S/fptrinstructcalleemulti1.checked.c %S/fptrinstructcalleemulti2.checked.c
