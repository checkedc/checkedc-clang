...
//RUN: %clang -c %S/fptrsafeprotocaller.checkedNOALL.c
//RUN: rm %S/fptrsafeprotocaller.checkedNOALL.c
...
/*For robustness, this test is identical to fptrsafecaller.c except in that
