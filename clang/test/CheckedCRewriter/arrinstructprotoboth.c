...
//RUN: %clang -c %S/arrinstructprotoboth.checkedNOALL.c
//RUN: rm %S/arrinstructprotoboth.checkedNOALL.c
...
/*For robustness, this test is identical to arrinstructboth.c except in that
