// RUN: cconv-standalone -base-dir=%S -output-postfix=checked %s %S/fptrarrstructbothmulti2.c
//RUN: %clang -c %S/fptrarrstructbothmulti1.checked.c %S/fptrarrstructbothmulti2.checked.c
