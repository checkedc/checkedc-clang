// RUN: cconv-standalone -base-dir=%S -output-postfix=checked %s %S/arrinstructsafemulti2.c
//RUN: %clang -c %S/arrinstructsafemulti1.checked.c %S/arrinstructsafemulti2.checked.c
