// RUN: cconv-standalone -base-dir=%S -alltypes -output-postfix=checkedALL %s %S/arrinstructsafemulti2.c
// RUN: cconv-standalone -base-dir=%S -output-postfix=checkedNOALL %s %S/arrinstructsafemulti2.c
//RUN: %clang -c %S/arrinstructsafemulti1.checkedNOALL.c %S/arrinstructsafemulti2.checkedNOALL.c
//RUN: FileCheck -match-full-lines -check-prefixes="CHECK_NOALL" --input-file %S/arrinstructsafemulti1.checkedNOALL.c %s
//RUN: FileCheck -match-full-lines -check-prefixes="CHECK_ALL" --input-file %S/arrinstructsafemulti1.checkedALL.c %s
...
//CHECK_NOALL: _Ptr<struct warr> sus(struct warr *, struct warr *y : itype(_Ptr<struct warr>));
//CHECK_ALL: _Ptr<struct warr> sus(struct warr *, struct warr *y : itype(_Ptr<struct warr>));
