...
//RUN: %clang -c %S/ptrTOptrprotocaller.checkedNOALL.c
//RUN: rm %S/ptrTOptrprotocaller.checkedNOALL.c
...
/*For robustness, this test is identical to ptrTOptrcaller.c except in that
