// RUN: cconv-standalone -base-dir=%S -output-postfix=checked %s %S/fptrarrcalleemulti2.c
//RUN: %clang -c %S/fptrarrcalleemulti1.checked.c %S/fptrarrcalleemulti2.checked.c
