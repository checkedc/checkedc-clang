// RUN: cconv-standalone -base-dir=%S -output-postfix=checked %s %S/fptrarrstructsafemulti2.c
//RUN: %clang -c %S/fptrarrstructsafemulti1.checked.c %S/fptrarrstructsafemulti2.checked.c
