// RUN: cconv-standalone -base-dir=%S -alltypes -output-postfix=checked2 %s %S/fptrunsafecalleemulti-alltypes1.c
//RUN: FileCheck -match-full-lines --input-file %S/fptrunsafecalleemulti-alltypes2.checked2.c %s
//RUN: rm %S/fptrunsafecalleemulti-alltypes1.checked2.c %S/fptrunsafecalleemulti-alltypes2.checked2.c
