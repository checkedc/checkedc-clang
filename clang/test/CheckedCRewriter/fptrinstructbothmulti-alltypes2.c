// RUN: cconv-standalone -base-dir=%S -alltypes -output-postfix=checked2 %s %S/fptrinstructbothmulti-alltypes1.c
//RUN: FileCheck -match-full-lines --input-file %S/fptrinstructbothmulti-alltypes2.checked2.c %s
//RUN: rm %S/fptrinstructbothmulti-alltypes1.checked2.c %S/fptrinstructbothmulti-alltypes2.checked2.c
...
/*For robustness, this test is identical to fptrinstructprotoboth-alltypes.c and fptrinstructboth-alltypes.c except in that
