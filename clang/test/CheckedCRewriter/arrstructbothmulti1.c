// RUN: cconv-standalone -base-dir=%S -output-postfix=checked %s %S/arrstructbothmulti2.c
//RUN: %clang -c %S/arrstructbothmulti1.checked.c %S/arrstructbothmulti2.checked.c
