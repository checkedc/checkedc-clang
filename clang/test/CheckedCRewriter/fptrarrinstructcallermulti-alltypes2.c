// RUN: cconv-standalone -base-dir=%S -alltypes -output-postfix=checked2 %s %S/fptrarrinstructcallermulti-alltypes1.c
//RUN: FileCheck -match-full-lines --input-file %S/fptrarrinstructcallermulti-alltypes2.checked2.c %s
//RUN: rm %S/fptrarrinstructcallermulti-alltypes1.checked2.c %S/fptrarrinstructcallermulti-alltypes2.checked2.c
