// RUN: cconv-standalone -base-dir=%S -alltypes -output-postfix=checked %s %S/arrofstructsafemulti-alltypes2.c
//RUN: FileCheck -match-full-lines --input-file %S/arrofstructsafemulti-alltypes1.checked.c %s
//RUN: rm %S/arrofstructsafemulti-alltypes1.checked.c %S/arrofstructsafemulti-alltypes2.checked.c
