// RUN: cconv-standalone -base-dir=%S -alltypes -output-postfix=checked2 %s %S/fptrarrcalleemulti-alltypes1.c
//RUN: FileCheck -match-full-lines --input-file %S/fptrarrcalleemulti-alltypes2.checked2.c %s
//RUN: rm %S/fptrarrcalleemulti-alltypes1.checked2.c %S/fptrarrcalleemulti-alltypes2.checked2.c
