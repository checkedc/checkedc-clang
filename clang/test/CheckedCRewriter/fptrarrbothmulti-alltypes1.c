// RUN: cconv-standalone -base-dir=%S -alltypes -output-postfix=checked %s %S/fptrarrbothmulti-alltypes2.c
//RUN: FileCheck -match-full-lines --input-file %S/fptrarrbothmulti-alltypes1.checked.c %s
//RUN: rm %S/fptrarrbothmulti-alltypes1.checked.c %S/fptrarrbothmulti-alltypes2.checked.c
...
/*For robustness, this test is identical to fptrarrprotoboth-alltypes.c and fptrarrboth-alltypes.c except in that
