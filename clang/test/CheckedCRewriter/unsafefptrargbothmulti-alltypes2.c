// RUN: cconv-standalone -base-dir=%S -alltypes -output-postfix=checked2 %s %S/unsafefptrargbothmulti-alltypes1.c
//RUN: FileCheck -match-full-lines --input-file %S/unsafefptrargbothmulti-alltypes2.checked2.c %s
//RUN: rm %S/unsafefptrargbothmulti-alltypes1.checked2.c %S/unsafefptrargbothmulti-alltypes2.checked2.c
...
/*For robustness, this test is identical to unsafefptrargprotoboth-alltypes.c and unsafefptrargboth-alltypes.c except in that
