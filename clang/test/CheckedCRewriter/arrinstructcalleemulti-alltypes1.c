// RUN: cconv-standalone -base-dir=%S -alltypes -output-postfix=checked %s %S/arrinstructcalleemulti-alltypes2.c
//RUN: FileCheck -match-full-lines --input-file %S/arrinstructcalleemulti-alltypes1.checked.c %s
//RUN: rm %S/arrinstructcalleemulti-alltypes1.checked.c %S/arrinstructcalleemulti-alltypes2.checked.c
...
/*For robustness, this test is identical to arrinstructprotocallee-alltypes.c and arrinstructcallee-alltypes.c except in that
