// RUN: cconv-standalone -base-dir=%S -alltypes -output-postfix=checked %s %S/fptrunsafebothmulti-alltypes2.c
//RUN: FileCheck -match-full-lines --input-file %S/fptrunsafebothmulti-alltypes1.checked.c %s
//RUN: rm %S/fptrunsafebothmulti-alltypes1.checked.c %S/fptrunsafebothmulti-alltypes2.checked.c
...
/*For robustness, this test is identical to fptrunsafeprotoboth-alltypes.c and fptrunsafeboth-alltypes.c except in that
