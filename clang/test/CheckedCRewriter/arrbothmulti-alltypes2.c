// RUN: cconv-standalone -base-dir=%S -alltypes -output-postfix=checked2 %s %S/arrbothmulti-alltypes1.c
//RUN: FileCheck -match-full-lines --input-file %S/arrbothmulti-alltypes2.checked2.c %s
//RUN: rm %S/arrbothmulti-alltypes1.checked2.c %S/arrbothmulti-alltypes2.checked2.c
...
/*For robustness, this test is identical to arrprotoboth-alltypes.c and arrboth-alltypes.c except in that
