// RUN: cconv-standalone -base-dir=%S -alltypes -output-postfix=checked %s %S/arrcalleemulti-alltypes2.c
//RUN: FileCheck -match-full-lines --input-file %S/arrcalleemulti-alltypes1.checked.c %s
//RUN: rm %S/arrcalleemulti-alltypes1.checked.c %S/arrcalleemulti-alltypes2.checked.c
