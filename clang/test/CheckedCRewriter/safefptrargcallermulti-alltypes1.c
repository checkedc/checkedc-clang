// RUN: cconv-standalone -base-dir=%S -alltypes -output-postfix=checked %s %S/safefptrargcallermulti-alltypes2.c
//RUN: FileCheck -match-full-lines --input-file %S/safefptrargcallermulti-alltypes1.checked.c %s
//RUN: rm %S/safefptrargcallermulti-alltypes1.checked.c %S/safefptrargcallermulti-alltypes2.checked.c
