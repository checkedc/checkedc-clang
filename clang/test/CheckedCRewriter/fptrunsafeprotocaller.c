...
//RUN: %clang -c %S/fptrunsafeprotocaller.checkedNOALL.c
//RUN: rm %S/fptrunsafeprotocaller.checkedNOALL.c
...
/*For robustness, this test is identical to fptrunsafecaller.c except in that
