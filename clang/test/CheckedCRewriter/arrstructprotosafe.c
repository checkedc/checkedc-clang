...
//RUN: %clang -c %S/arrstructprotosafe.checkedNOALL.c
//RUN: rm %S/arrstructprotosafe.checkedNOALL.c
...
/*For robustness, this test is identical to arrstructsafe.c except in that
