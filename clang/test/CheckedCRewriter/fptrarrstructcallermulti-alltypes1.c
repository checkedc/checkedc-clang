// RUN: cconv-standalone -base-dir=%S -alltypes -output-postfix=checked %s %S/fptrarrstructcallermulti-alltypes2.c
//RUN: FileCheck -match-full-lines --input-file %S/fptrarrstructcallermulti-alltypes1.checked.c %s
//RUN: rm %S/fptrarrstructcallermulti-alltypes1.checked.c %S/fptrarrstructcallermulti-alltypes2.checked.c
