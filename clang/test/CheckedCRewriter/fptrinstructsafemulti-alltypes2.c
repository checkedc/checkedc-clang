// RUN: cconv-standalone -base-dir=%S -alltypes -output-postfix=checked2 %s %S/fptrinstructsafemulti-alltypes1.c
//RUN: FileCheck -match-full-lines --input-file %S/fptrinstructsafemulti-alltypes2.checked2.c %s
//RUN: rm %S/fptrinstructsafemulti-alltypes1.checked2.c %S/fptrinstructsafemulti-alltypes2.checked2.c
