// RUN: cconv-standalone -base-dir=%S -alltypes -output-postfix=checked %s %S/safefptrargbothmulti-alltypes2.c
//RUN: FileCheck -match-full-lines --input-file %S/safefptrargbothmulti-alltypes1.checked.c %s
//RUN: rm %S/safefptrargbothmulti-alltypes1.checked.c %S/safefptrargbothmulti-alltypes2.checked.c
...
/*For robustness, this test is identical to safefptrargprotoboth-alltypes.c and safefptrargboth-alltypes.c except in that
