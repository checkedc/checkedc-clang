// RUN: cconv-standalone -base-dir=%S -output-postfix=checked %s %S/fptrarrinstructbothmulti2.c
//RUN: %clang -c %S/fptrarrinstructbothmulti1.checked.c %S/fptrarrinstructbothmulti2.checked.c
