// RUN: cconv-standalone -base-dir=%S -output-postfix=checked %s %S/safefptrargsafemulti2.c
//RUN: %clang -c %S/safefptrargsafemulti1.checked.c %S/safefptrargsafemulti2.checked.c
