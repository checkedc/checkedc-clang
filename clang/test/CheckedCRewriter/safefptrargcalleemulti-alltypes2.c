// RUN: cconv-standalone -base-dir=%S -alltypes -output-postfix=checked2 %s %S/safefptrargcalleemulti-alltypes1.c
//RUN: FileCheck -match-full-lines --input-file %S/safefptrargcalleemulti-alltypes2.checked2.c %s
//RUN: rm %S/safefptrargcalleemulti-alltypes1.checked2.c %S/safefptrargcalleemulti-alltypes2.checked2.c
...
/*For robustness, this test is identical to safefptrargprotocallee-alltypes.c and safefptrargcallee-alltypes.c except in that
