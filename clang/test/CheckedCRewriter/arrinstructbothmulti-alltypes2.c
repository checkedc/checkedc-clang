// RUN: cconv-standalone -base-dir=%S -alltypes -output-postfix=checked2 %s %S/arrinstructbothmulti-alltypes1.c
//RUN: FileCheck -match-full-lines --input-file %S/arrinstructbothmulti-alltypes2.checked2.c %s
//RUN: rm %S/arrinstructbothmulti-alltypes1.checked2.c %S/arrinstructbothmulti-alltypes2.checked2.c
