// RUN: cconv-standalone -base-dir=%S -alltypes -output-postfix=checked2 %s %S/fptrarrsafemulti-alltypes1.c
//RUN: FileCheck -match-full-lines --input-file %S/fptrarrsafemulti-alltypes2.checked2.c %s
//RUN: rm %S/fptrarrsafemulti-alltypes1.checked2.c %S/fptrarrsafemulti-alltypes2.checked2.c
...
/*For robustness, this test is identical to fptrarrprotosafe-alltypes.c and fptrarrsafe-alltypes.c except in that
