// RUN: cconv-standalone -base-dir=%S -alltypes -output-postfix=checked2 %s %S/fptrarrcallermulti-alltypes1.c
//RUN: FileCheck -match-full-lines --input-file %S/fptrarrcallermulti-alltypes2.checked2.c %s
//RUN: rm %S/fptrarrcallermulti-alltypes1.checked2.c %S/fptrarrcallermulti-alltypes2.checked2.c
...
/*For robustness, this test is identical to fptrarrprotocaller-alltypes.c and fptrarrcaller-alltypes.c except in that
