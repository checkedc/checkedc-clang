// RUN: cconv-standalone -base-dir=%S -alltypes -output-postfix=checked2 %s %S/arrstructcalleemulti-alltypes1.c
//RUN: FileCheck -match-full-lines --input-file %S/arrstructcalleemulti-alltypes2.checked2.c %s
//RUN: rm %S/arrstructcalleemulti-alltypes1.checked2.c %S/arrstructcalleemulti-alltypes2.checked2.c
