// RUN: cconv-standalone -base-dir=%S -alltypes -output-postfix=checked2 %s %S/fptrsafesafemulti-alltypes1.c
//RUN: FileCheck -match-full-lines --input-file %S/fptrsafesafemulti-alltypes2.checked2.c %s
//RUN: rm %S/fptrsafesafemulti-alltypes1.checked2.c %S/fptrsafesafemulti-alltypes2.checked2.c
