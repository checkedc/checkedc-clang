// RUN: cconv-standalone -base-dir=%S -alltypes -output-postfix=checked %s %S/fptrarrstructbothmulti-alltypes2.c
//RUN: FileCheck -match-full-lines --input-file %S/fptrarrstructbothmulti-alltypes1.checked.c %s
//RUN: rm %S/fptrarrstructbothmulti-alltypes1.checked.c %S/fptrarrstructbothmulti-alltypes2.checked.c
