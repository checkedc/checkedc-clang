// RUN: cconv-standalone -base-dir=%S -alltypes -output-postfix=checked2 %s %S/arrofstructsafemulti-alltypes1.c
//RUN: FileCheck -match-full-lines --input-file %S/arrofstructsafemulti-alltypes2.checked2.c %s
//RUN: rm %S/arrofstructsafemulti-alltypes1.checked2.c %S/arrofstructsafemulti-alltypes2.checked2.c
...
of structs*/
/*For robustness, this test is identical to arrofstructprotosafe-alltypes.c and arrofstructsafe-alltypes.c except in that
