// RUN: cconv-standalone -base-dir=%S -output-postfix=checked %s %S/fptrsafebothmulti2.c
//RUN: %clang -c %S/fptrsafebothmulti1.checked.c %S/fptrsafebothmulti2.checked.c
