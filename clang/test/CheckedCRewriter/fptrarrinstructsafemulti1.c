// RUN: cconv-standalone -base-dir=%S -output-postfix=checked %s %S/fptrarrinstructsafemulti2.c
//RUN: %clang -c %S/fptrarrinstructsafemulti1.checked.c %S/fptrarrinstructsafemulti2.checked.c
