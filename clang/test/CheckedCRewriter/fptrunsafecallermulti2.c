// RUN: cconv-standalone -base-dir=%S -alltypes -output-postfix=checkedALL2 %S/fptrunsafecallermulti1.c %s
// RUN: cconv-standalone -base-dir=%S -output-postfix=checkedNOALL2 %S/fptrunsafecallermulti1.c %s
