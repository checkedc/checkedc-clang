// RUN: cconv-standalone -base-dir=%S -alltypes -output-postfix=checked %s %S/fptrsafebothmulti-alltypes2.c
//RUN: FileCheck -match-full-lines --input-file %S/fptrsafebothmulti-alltypes1.checked.c %s
//RUN: rm %S/fptrsafebothmulti-alltypes1.checked.c %S/fptrsafebothmulti-alltypes2.checked.c
