// RUN: cconv-standalone -base-dir=%S -alltypes -output-postfix=checked %s %S/fptrarrinstructcalleemulti-alltypes2.c
//RUN: FileCheck -match-full-lines --input-file %S/fptrarrinstructcalleemulti-alltypes1.checked.c %s
//RUN: rm %S/fptrarrinstructcalleemulti-alltypes1.checked.c %S/fptrarrinstructcalleemulti-alltypes2.checked.c
