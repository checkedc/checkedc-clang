// RUN: cconv-standalone -base-dir=%S -alltypes -output-postfix=checked %s %S/arrstructsafemulti-alltypes2.c
//RUN: FileCheck -match-full-lines --input-file %S/arrstructsafemulti-alltypes1.checked.c %s
//RUN: rm %S/arrstructsafemulti-alltypes1.checked.c %S/arrstructsafemulti-alltypes2.checked.c
