// RUN: cconv-standalone -base-dir=%S -alltypes -output-postfix=checked %s %S/fptrarrinstructbothmulti-alltypes2.c
//RUN: FileCheck -match-full-lines --input-file %S/fptrarrinstructbothmulti-alltypes1.checked.c %s
//RUN: rm %S/fptrarrinstructbothmulti-alltypes1.checked.c %S/fptrarrinstructbothmulti-alltypes2.checked.c
