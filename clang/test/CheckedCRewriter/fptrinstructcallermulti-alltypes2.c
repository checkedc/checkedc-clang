// RUN: cconv-standalone -base-dir=%S -alltypes -output-postfix=checked2 %s %S/fptrinstructcallermulti-alltypes1.c
//RUN: FileCheck -match-full-lines --input-file %S/fptrinstructcallermulti-alltypes2.checked2.c %s
//RUN: rm %S/fptrinstructcallermulti-alltypes1.checked2.c %S/fptrinstructcallermulti-alltypes2.checked2.c
...
/*For robustness, this test is identical to fptrinstructprotocaller-alltypes.c and fptrinstructcaller-alltypes.c except in that
