// RUN: cconv-standalone -base-dir=%S -alltypes -output-postfix=checked %s %S/arrstructbothmulti-alltypes2.c
//RUN: FileCheck -match-full-lines --input-file %S/arrstructbothmulti-alltypes1.checked.c %s
//RUN: rm %S/arrstructbothmulti-alltypes1.checked.c %S/arrstructbothmulti-alltypes2.checked.c
