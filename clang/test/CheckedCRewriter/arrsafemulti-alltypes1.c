// RUN: cconv-standalone -base-dir=%S -alltypes -output-postfix=checked %s %S/arrsafemulti-alltypes2.c
//RUN: FileCheck -match-full-lines --input-file %S/arrsafemulti-alltypes1.checked.c %s
//RUN: rm %S/arrsafemulti-alltypes1.checked.c %S/arrsafemulti-alltypes2.checked.c
...
/*For robustness, this test is identical to arrprotosafe-alltypes.c and arrsafe-alltypes.c except in that
