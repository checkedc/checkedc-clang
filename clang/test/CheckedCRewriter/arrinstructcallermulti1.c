// RUN: cconv-standalone -base-dir=%S -output-postfix=checked %s %S/arrinstructcallermulti2.c
//RUN: %clang -c %S/arrinstructcallermulti1.checked.c %S/arrinstructcallermulti2.checked.c
