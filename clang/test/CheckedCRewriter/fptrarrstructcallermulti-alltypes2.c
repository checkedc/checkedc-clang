// RUN: cconv-standalone -base-dir=%S -alltypes -output-postfix=checked2 %s %S/fptrarrstructcallermulti-alltypes1.c
//RUN: FileCheck -match-full-lines --input-file %S/fptrarrstructcallermulti-alltypes2.checked2.c %s
//RUN: rm %S/fptrarrstructcallermulti-alltypes1.checked2.c %S/fptrarrstructcallermulti-alltypes2.checked2.c
...
/*For robustness, this test is identical to fptrarrstructprotocaller-alltypes.c and fptrarrstructcaller-alltypes.c except in that
