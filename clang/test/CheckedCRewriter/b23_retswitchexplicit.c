...
//RUN: %clang -c %S/b23_retswitchexplicit.checkedNOALL.c
//RUN: rm %S/b23_retswitchexplicit.checkedNOALL.c
...
//CHECK_NOALL:   int *z = malloc<int>(sizeof(int));
