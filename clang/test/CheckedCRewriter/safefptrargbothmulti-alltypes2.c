// RUN: cconv-standalone -base-dir=%S -alltypes -output-postfix=checked2 %s %S/safefptrargbothmulti-alltypes1.c
//RUN: FileCheck -match-full-lines --input-file %S/safefptrargbothmulti-alltypes2.checked2.c %s
//RUN: rm %S/safefptrargbothmulti-alltypes1.checked2.c %S/safefptrargbothmulti-alltypes2.checked2.c
