// RUN: cconv-standalone -base-dir=%S -output-postfix=checked %s %S/fptrarrstructcallermulti2.c
//RUN: %clang -c %S/fptrarrstructcallermulti1.checked.c %S/fptrarrstructcallermulti2.checked.c
