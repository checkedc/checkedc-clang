// RUN: cconv-standalone -base-dir=%S -alltypes -output-postfix=checked %s %S/unsafefptrargbothmulti-alltypes2.c
//RUN: FileCheck -match-full-lines --input-file %S/unsafefptrargbothmulti-alltypes1.checked.c %s
//RUN: rm %S/unsafefptrargbothmulti-alltypes1.checked.c %S/unsafefptrargbothmulti-alltypes2.checked.c
