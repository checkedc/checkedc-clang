// RUN: cconv-standalone -base-dir=%S -alltypes -output-postfix=checked %s %S/fptrsafesafemulti-alltypes2.c
//RUN: FileCheck -match-full-lines --input-file %S/fptrsafesafemulti-alltypes1.checked.c %s
//RUN: rm %S/fptrsafesafemulti-alltypes1.checked.c %S/fptrsafesafemulti-alltypes2.checked.c
...
/*For robustness, this test is identical to fptrsafeprotosafe-alltypes.c and fptrsafesafe-alltypes.c except in that
