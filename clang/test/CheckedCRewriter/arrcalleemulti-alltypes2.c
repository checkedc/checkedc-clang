// RUN: cconv-standalone -base-dir=%S -alltypes -output-postfix=checked2 %s %S/arrcalleemulti-alltypes1.c
//RUN: FileCheck -match-full-lines --input-file %S/arrcalleemulti-alltypes2.checked2.c %s
//RUN: rm %S/arrcalleemulti-alltypes1.checked2.c %S/arrcalleemulti-alltypes2.checked2.c
...
/*For robustness, this test is identical to arrprotocallee-alltypes.c and arrcallee-alltypes.c except in that
