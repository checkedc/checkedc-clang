// RUN: cconv-standalone -base-dir=%S -output-postfix=checked %s %S/fptrunsafecallermulti2.c
//RUN: %clang -c %S/fptrunsafecallermulti1.checked.c %S/fptrunsafecallermulti2.checked.c
