...
//RUN: %clang -c %S/safefptrargprotosafe.checkedNOALL.c
//RUN: rm %S/safefptrargprotosafe.checkedNOALL.c
...
/*For robustness, this test is identical to safefptrargsafe.c except in that
