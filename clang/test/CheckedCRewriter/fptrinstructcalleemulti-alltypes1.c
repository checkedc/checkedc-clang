// RUN: cconv-standalone -base-dir=%S -alltypes -output-postfix=checked %s %S/fptrinstructcalleemulti-alltypes2.c
//RUN: FileCheck -match-full-lines --input-file %S/fptrinstructcalleemulti-alltypes1.checked.c %s
//RUN: rm %S/fptrinstructcalleemulti-alltypes1.checked.c %S/fptrinstructcalleemulti-alltypes2.checked.c
