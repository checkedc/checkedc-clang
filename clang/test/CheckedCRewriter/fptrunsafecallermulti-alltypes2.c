// RUN: cconv-standalone -base-dir=%S -alltypes -output-postfix=checked2 %s %S/fptrunsafecallermulti-alltypes1.c
//RUN: FileCheck -match-full-lines --input-file %S/fptrunsafecallermulti-alltypes2.checked2.c %s
//RUN: rm %S/fptrunsafecallermulti-alltypes1.checked2.c %S/fptrunsafecallermulti-alltypes2.checked2.c
...
/*For robustness, this test is identical to fptrunsafeprotocaller-alltypes.c and fptrunsafecaller-alltypes.c except in that
