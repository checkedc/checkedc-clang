// RUN: cconv-standalone -base-dir=%S -alltypes -output-postfix=checked %s %S/fptrunsafesafemulti-alltypes2.c
//RUN: FileCheck -match-full-lines --input-file %S/fptrunsafesafemulti-alltypes1.checked.c %s
//RUN: rm %S/fptrunsafesafemulti-alltypes1.checked.c %S/fptrunsafesafemulti-alltypes2.checked.c
