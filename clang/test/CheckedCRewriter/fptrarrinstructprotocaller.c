...
//RUN: %clang -c %S/fptrarrinstructprotocaller.checkedNOALL.c
//RUN: rm %S/fptrarrinstructprotocaller.checkedNOALL.c
...
/*For robustness, this test is identical to fptrarrinstructcaller.c except in that
