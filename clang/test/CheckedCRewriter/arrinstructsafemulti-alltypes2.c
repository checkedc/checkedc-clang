// RUN: cconv-standalone -base-dir=%S -alltypes -output-postfix=checked2 %s %S/arrinstructsafemulti-alltypes1.c
//RUN: FileCheck -match-full-lines --input-file %S/arrinstructsafemulti-alltypes2.checked2.c %s
//RUN: rm %S/arrinstructsafemulti-alltypes1.checked2.c %S/arrinstructsafemulti-alltypes2.checked2.c
