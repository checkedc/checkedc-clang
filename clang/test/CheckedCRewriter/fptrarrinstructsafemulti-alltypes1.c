// RUN: cconv-standalone -base-dir=%S -alltypes -output-postfix=checked %s %S/fptrarrinstructsafemulti-alltypes2.c
//RUN: FileCheck -match-full-lines --input-file %S/fptrarrinstructsafemulti-alltypes1.checked.c %s
//RUN: rm %S/fptrarrinstructsafemulti-alltypes1.checked.c %S/fptrarrinstructsafemulti-alltypes2.checked.c
