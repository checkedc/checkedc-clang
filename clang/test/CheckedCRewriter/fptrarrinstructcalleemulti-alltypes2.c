// RUN: cconv-standalone -base-dir=%S -alltypes -output-postfix=checked2 %s %S/fptrarrinstructcalleemulti-alltypes1.c
//RUN: FileCheck -match-full-lines --input-file %S/fptrarrinstructcalleemulti-alltypes2.checked2.c %s
//RUN: rm %S/fptrarrinstructcalleemulti-alltypes1.checked2.c %S/fptrarrinstructcalleemulti-alltypes2.checked2.c
...
/*For robustness, this test is identical to fptrarrinstructprotocallee-alltypes.c and fptrarrinstructcallee-alltypes.c except in that
