// RUN: cconv-standalone -base-dir=%S -alltypes -output-postfix=checked %s %S/fptrinstructcallermulti-alltypes2.c
//RUN: FileCheck -match-full-lines --input-file %S/fptrinstructcallermulti-alltypes1.checked.c %s
//RUN: rm %S/fptrinstructcallermulti-alltypes1.checked.c %S/fptrinstructcallermulti-alltypes2.checked.c
