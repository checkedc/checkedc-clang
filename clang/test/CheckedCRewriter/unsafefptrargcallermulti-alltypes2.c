// RUN: cconv-standalone -base-dir=%S -alltypes -output-postfix=checked2 %s %S/unsafefptrargcallermulti-alltypes1.c
//RUN: FileCheck -match-full-lines --input-file %S/unsafefptrargcallermulti-alltypes2.checked2.c %s
//RUN: rm %S/unsafefptrargcallermulti-alltypes1.checked2.c %S/unsafefptrargcallermulti-alltypes2.checked2.c
