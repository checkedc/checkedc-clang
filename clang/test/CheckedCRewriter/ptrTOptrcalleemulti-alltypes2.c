// RUN: cconv-standalone -base-dir=%S -alltypes -output-postfix=checked2 %s %S/ptrTOptrcalleemulti-alltypes1.c
//RUN: FileCheck -match-full-lines --input-file %S/ptrTOptrcalleemulti-alltypes2.checked2.c %s
//RUN: rm %S/ptrTOptrcalleemulti-alltypes1.checked2.c %S/ptrTOptrcalleemulti-alltypes2.checked2.c
...
/*For robustness, this test is identical to ptrTOptrprotocallee-alltypes.c and ptrTOptrcallee-alltypes.c except in that
