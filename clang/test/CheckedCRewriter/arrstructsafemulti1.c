// RUN: cconv-standalone -base-dir=%S -output-postfix=checked %s %S/arrstructsafemulti2.c
//RUN: %clang -c %S/arrstructsafemulti1.checked.c %S/arrstructsafemulti2.checked.c
