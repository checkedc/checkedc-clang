// RUN: cconv-standalone -base-dir=%S -alltypes -output-postfix=checked %s %S/arrstructcallermulti-alltypes2.c
//RUN: FileCheck -match-full-lines --input-file %S/arrstructcallermulti-alltypes1.checked.c %s
//RUN: rm %S/arrstructcallermulti-alltypes1.checked.c %S/arrstructcallermulti-alltypes2.checked.c
...
/*For robustness, this test is identical to arrstructprotocaller-alltypes.c and arrstructcaller-alltypes.c except in that
