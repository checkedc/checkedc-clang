// RUN: cconv-standalone -base-dir=%S -alltypes -output-postfix=checked2 %s %S/unsafefptrargcalleemulti-alltypes1.c
//RUN: FileCheck -match-full-lines --input-file %S/unsafefptrargcalleemulti-alltypes2.checked2.c %s
//RUN: rm %S/unsafefptrargcalleemulti-alltypes1.checked2.c %S/unsafefptrargcalleemulti-alltypes2.checked2.c
...
/*For robustness, this test is identical to unsafefptrargprotocallee-alltypes.c and unsafefptrargcallee-alltypes.c except in that
