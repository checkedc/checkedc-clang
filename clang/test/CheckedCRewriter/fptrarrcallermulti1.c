// RUN: cconv-standalone -base-dir=%S -output-postfix=checked %s %S/fptrarrcallermulti2.c
//RUN: %clang -c %S/fptrarrcallermulti1.checked.c %S/fptrarrcallermulti2.checked.c
