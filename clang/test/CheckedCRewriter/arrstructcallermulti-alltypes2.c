// RUN: cconv-standalone -base-dir=%S -alltypes -output-postfix=checked2 %s %S/arrstructcallermulti-alltypes1.c
//RUN: FileCheck -match-full-lines --input-file %S/arrstructcallermulti-alltypes2.checked2.c %s
//RUN: rm %S/arrstructcallermulti-alltypes1.checked2.c %S/arrstructcallermulti-alltypes2.checked2.c
