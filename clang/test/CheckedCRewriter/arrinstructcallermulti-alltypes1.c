// RUN: cconv-standalone -base-dir=%S -alltypes -output-postfix=checked %s %S/arrinstructcallermulti-alltypes2.c
//RUN: FileCheck -match-full-lines --input-file %S/arrinstructcallermulti-alltypes1.checked.c %s
//RUN: rm %S/arrinstructcallermulti-alltypes1.checked.c %S/arrinstructcallermulti-alltypes2.checked.c
