// RUN: cconv-standalone -base-dir=%S -alltypes -output-postfix=checked %s %S/safefptrargsafemulti-alltypes2.c
//RUN: FileCheck -match-full-lines --input-file %S/safefptrargsafemulti-alltypes1.checked.c %s
//RUN: rm %S/safefptrargsafemulti-alltypes1.checked.c %S/safefptrargsafemulti-alltypes2.checked.c
