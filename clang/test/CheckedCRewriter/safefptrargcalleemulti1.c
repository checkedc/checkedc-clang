// RUN: cconv-standalone -base-dir=%S -output-postfix=checked %s %S/safefptrargcalleemulti2.c
//RUN: %clang -c %S/safefptrargcalleemulti1.checked.c %S/safefptrargcalleemulti2.checked.c
