// RUN: cconv-standalone -base-dir=%S -alltypes -output-postfix=checked2 %s %S/fptrarrinstructsafemulti-alltypes1.c
//RUN: FileCheck -match-full-lines --input-file %S/fptrarrinstructsafemulti-alltypes2.checked2.c %s
//RUN: rm %S/fptrarrinstructsafemulti-alltypes1.checked2.c %S/fptrarrinstructsafemulti-alltypes2.checked2.c
...
/*For robustness, this test is identical to fptrarrinstructprotosafe-alltypes.c and fptrarrinstructsafe-alltypes.c except in that
