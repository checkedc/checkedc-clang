// RUN: cconv-standalone -base-dir=%S -output-postfix=checked %s %S/safefptrargcallermulti2.c
//RUN: %clang -c %S/safefptrargcallermulti1.checked.c %S/safefptrargcallermulti2.checked.c
