// RUN: cconv-standalone -base-dir=%S -alltypes -output-postfix=checked2 %s %S/fptrinstructcalleemulti-alltypes1.c
//RUN: FileCheck -match-full-lines --input-file %S/fptrinstructcalleemulti-alltypes2.checked2.c %s
//RUN: rm %S/fptrinstructcalleemulti-alltypes1.checked2.c %S/fptrinstructcalleemulti-alltypes2.checked2.c
...
/*For robustness, this test is identical to fptrinstructprotocallee-alltypes.c and fptrinstructcallee-alltypes.c except in that
