// RUN: cconv-standalone -base-dir=%S -alltypes -output-postfix=checked %s %S/fptrunsafecallermulti-alltypes2.c
//RUN: FileCheck -match-full-lines --input-file %S/fptrunsafecallermulti-alltypes1.checked.c %s
//RUN: rm %S/fptrunsafecallermulti-alltypes1.checked.c %S/fptrunsafecallermulti-alltypes2.checked.c
