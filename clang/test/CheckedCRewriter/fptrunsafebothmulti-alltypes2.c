// RUN: cconv-standalone -base-dir=%S -alltypes -output-postfix=checked2 %s %S/fptrunsafebothmulti-alltypes1.c
//RUN: FileCheck -match-full-lines --input-file %S/fptrunsafebothmulti-alltypes2.checked2.c %s
//RUN: rm %S/fptrunsafebothmulti-alltypes1.checked2.c %S/fptrunsafebothmulti-alltypes2.checked2.c
