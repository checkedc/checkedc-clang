// RUN: cconv-standalone -base-dir=%S -alltypes -output-postfix=checked %s %S/arrinstructsafemulti-alltypes2.c
//RUN: FileCheck -match-full-lines --input-file %S/arrinstructsafemulti-alltypes1.checked.c %s
//RUN: rm %S/arrinstructsafemulti-alltypes1.checked.c %S/arrinstructsafemulti-alltypes2.checked.c
