// RUN: cconv-standalone -base-dir=%S -alltypes -output-postfix=checked2 %s %S/unsafefptrargsafemulti-alltypes1.c
//RUN: FileCheck -match-full-lines --input-file %S/unsafefptrargsafemulti-alltypes2.checked2.c %s
//RUN: rm %S/unsafefptrargsafemulti-alltypes1.checked2.c %S/unsafefptrargsafemulti-alltypes2.checked2.c
