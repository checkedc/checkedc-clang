// RUN: cconv-standalone -base-dir=%S -alltypes -output-postfix=checked %s %S/fptrarrcallermulti-alltypes2.c
//RUN: FileCheck -match-full-lines --input-file %S/fptrarrcallermulti-alltypes1.checked.c %s
//RUN: rm %S/fptrarrcallermulti-alltypes1.checked.c %S/fptrarrcallermulti-alltypes2.checked.c
