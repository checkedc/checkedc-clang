// RUN: cconv-standalone -base-dir=%S -alltypes -output-postfix=checkedALL2 %S/arrsafemulti1.c %s
// RUN: cconv-standalone -base-dir=%S -output-postfix=checkedNOALL2 %S/arrsafemulti1.c %s
