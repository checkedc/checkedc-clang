// RUN: cconv-standalone -base-dir=%S -alltypes -output-postfix=checked2 %s %S/arrofstructcallermulti-alltypes1.c
//RUN: FileCheck -match-full-lines --input-file %S/arrofstructcallermulti-alltypes2.checked2.c %s
//RUN: rm %S/arrofstructcallermulti-alltypes1.checked2.c %S/arrofstructcallermulti-alltypes2.checked2.c
...
of structs*/
/*For robustness, this test is identical to arrofstructprotocaller-alltypes.c and arrofstructcaller-alltypes.c except in that
