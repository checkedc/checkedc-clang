// RUN: cconv-standalone -base-dir=%S -alltypes -output-postfix=checked %s %S/fptrinstructbothmulti-alltypes2.c
//RUN: FileCheck -match-full-lines --input-file %S/fptrinstructbothmulti-alltypes1.checked.c %s
//RUN: rm %S/fptrinstructbothmulti-alltypes1.checked.c %S/fptrinstructbothmulti-alltypes2.checked.c
