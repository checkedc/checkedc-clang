// RUN: cconv-standalone -base-dir=%S -alltypes -output-postfix=checked2 %s %S/fptrarrbothmulti-alltypes1.c
//RUN: FileCheck -match-full-lines --input-file %S/fptrarrbothmulti-alltypes2.checked2.c %s
//RUN: rm %S/fptrarrbothmulti-alltypes1.checked2.c %S/fptrarrbothmulti-alltypes2.checked2.c
