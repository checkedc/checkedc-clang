// RUN: cconv-standalone -base-dir=%S -alltypes -output-postfix=checked2 %s %S/arrcallermulti-alltypes1.c
//RUN: FileCheck -match-full-lines --input-file %S/arrcallermulti-alltypes2.checked2.c %s
//RUN: rm %S/arrcallermulti-alltypes1.checked2.c %S/arrcallermulti-alltypes2.checked2.c
