// RUN: cconv-standalone -base-dir=%S -alltypes -output-postfix=checked2 %s %S/ptrTOptrsafemulti-alltypes1.c
//RUN: FileCheck -match-full-lines --input-file %S/ptrTOptrsafemulti-alltypes2.checked2.c %s
//RUN: rm %S/ptrTOptrsafemulti-alltypes1.checked2.c %S/ptrTOptrsafemulti-alltypes2.checked2.c
