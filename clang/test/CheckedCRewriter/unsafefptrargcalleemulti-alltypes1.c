// RUN: cconv-standalone -base-dir=%S -alltypes -output-postfix=checked %s %S/unsafefptrargcalleemulti-alltypes2.c
//RUN: FileCheck -match-full-lines --input-file %S/unsafefptrargcalleemulti-alltypes1.checked.c %s
//RUN: rm %S/unsafefptrargcalleemulti-alltypes1.checked.c %S/unsafefptrargcalleemulti-alltypes2.checked.c
