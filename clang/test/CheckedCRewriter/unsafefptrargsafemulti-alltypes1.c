// RUN: cconv-standalone -base-dir=%S -alltypes -output-postfix=checked %s %S/unsafefptrargsafemulti-alltypes2.c
//RUN: FileCheck -match-full-lines --input-file %S/unsafefptrargsafemulti-alltypes1.checked.c %s
//RUN: rm %S/unsafefptrargsafemulti-alltypes1.checked.c %S/unsafefptrargsafemulti-alltypes2.checked.c
...
/*For robustness, this test is identical to unsafefptrargprotosafe-alltypes.c and unsafefptrargsafe-alltypes.c except in that
