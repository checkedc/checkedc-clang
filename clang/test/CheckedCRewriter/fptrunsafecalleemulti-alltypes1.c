// RUN: cconv-standalone -base-dir=%S -alltypes -output-postfix=checked %s %S/fptrunsafecalleemulti-alltypes2.c
//RUN: FileCheck -match-full-lines --input-file %S/fptrunsafecalleemulti-alltypes1.checked.c %s
//RUN: rm %S/fptrunsafecalleemulti-alltypes1.checked.c %S/fptrunsafecalleemulti-alltypes2.checked.c
...
/*For robustness, this test is identical to fptrunsafeprotocallee-alltypes.c and fptrunsafecallee-alltypes.c except in that
