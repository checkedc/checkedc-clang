// RUN: cconv-standalone -base-dir=%S -output-postfix=checked %s %S/fptrsafecalleemulti2.c
//RUN: %clang -c %S/fptrsafecalleemulti1.checked.c %S/fptrsafecalleemulti2.checked.c
