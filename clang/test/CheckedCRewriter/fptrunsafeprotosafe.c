...
//RUN: %clang -c %S/fptrunsafeprotosafe.checkedNOALL.c
//RUN: rm %S/fptrunsafeprotosafe.checkedNOALL.c
...
/*For robustness, this test is identical to fptrunsafesafe.c except in that
