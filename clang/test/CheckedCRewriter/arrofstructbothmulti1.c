// RUN: cconv-standalone -base-dir=%S -output-postfix=checked %s %S/arrofstructbothmulti2.c
//RUN: %clang -c %S/arrofstructbothmulti1.checked.c %S/arrofstructbothmulti2.checked.c
