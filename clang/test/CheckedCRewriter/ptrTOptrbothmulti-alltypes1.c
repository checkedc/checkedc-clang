// RUN: cconv-standalone -base-dir=%S -alltypes -output-postfix=checked %s %S/ptrTOptrbothmulti-alltypes2.c
//RUN: FileCheck -match-full-lines --input-file %S/ptrTOptrbothmulti-alltypes1.checked.c %s
//RUN: rm %S/ptrTOptrbothmulti-alltypes1.checked.c %S/ptrTOptrbothmulti-alltypes2.checked.c
