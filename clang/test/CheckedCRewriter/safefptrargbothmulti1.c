// RUN: cconv-standalone -base-dir=%S -alltypes -output-postfix=checkedALL %s %S/safefptrargbothmulti2.c
// RUN: cconv-standalone -base-dir=%S -output-postfix=checkedNOALL %s %S/safefptrargbothmulti2.c
//RUN: %clang -c %S/safefptrargbothmulti1.checkedNOALL.c %S/safefptrargbothmulti2.checkedNOALL.c
//RUN: FileCheck -match-full-lines -check-prefixes="CHECK_NOALL" --input-file %S/safefptrargbothmulti1.checkedNOALL.c %s
//RUN: FileCheck -match-full-lines -check-prefixes="CHECK_ALL" --input-file %S/safefptrargbothmulti1.checkedALL.c %s
