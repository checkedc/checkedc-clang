// RUN: cconv-standalone -base-dir=%S -output-postfix=checked %s %S/safefptrargbothmulti2.c
//RUN: %clang -c %S/safefptrargbothmulti1.checked.c %S/safefptrargbothmulti2.checked.c
