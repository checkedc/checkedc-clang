// RUN: cconv-standalone -base-dir=%S -output-postfix=checked %s %S/fptrunsafesafemulti2.c
//RUN: %clang -c %S/fptrunsafesafemulti1.checked.c %S/fptrunsafesafemulti2.checked.c
