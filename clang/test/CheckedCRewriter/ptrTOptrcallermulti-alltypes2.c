// RUN: cconv-standalone -base-dir=%S -alltypes -output-postfix=checked2 %s %S/ptrTOptrcallermulti-alltypes1.c
//RUN: FileCheck -match-full-lines --input-file %S/ptrTOptrcallermulti-alltypes2.checked2.c %s
//RUN: rm %S/ptrTOptrcallermulti-alltypes1.checked2.c %S/ptrTOptrcallermulti-alltypes2.checked2.c
...
/*For robustness, this test is identical to ptrTOptrprotocaller-alltypes.c and ptrTOptrcaller-alltypes.c except in that
