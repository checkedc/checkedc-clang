// RUN: cconv-standalone -base-dir=%S -alltypes -output-postfix=checked2 %s %S/arrstructsafemulti-alltypes1.c
//RUN: FileCheck -match-full-lines --input-file %S/arrstructsafemulti-alltypes2.checked2.c %s
//RUN: rm %S/arrstructsafemulti-alltypes1.checked2.c %S/arrstructsafemulti-alltypes2.checked2.c
...
/*For robustness, this test is identical to arrstructprotosafe-alltypes.c and arrstructsafe-alltypes.c except in that
