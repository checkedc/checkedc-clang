// RUN: cconv-standalone -base-dir=%S -alltypes -output-postfix=checked %s %S/ptrTOptrsafemulti-alltypes2.c
//RUN: FileCheck -match-full-lines --input-file %S/ptrTOptrsafemulti-alltypes1.checked.c %s
//RUN: rm %S/ptrTOptrsafemulti-alltypes1.checked.c %S/ptrTOptrsafemulti-alltypes2.checked.c
