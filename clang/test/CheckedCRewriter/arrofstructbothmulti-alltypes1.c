// RUN: cconv-standalone -base-dir=%S -alltypes -output-postfix=checked %s %S/arrofstructbothmulti-alltypes2.c
//RUN: FileCheck -match-full-lines --input-file %S/arrofstructbothmulti-alltypes1.checked.c %s
//RUN: rm %S/arrofstructbothmulti-alltypes1.checked.c %S/arrofstructbothmulti-alltypes2.checked.c
