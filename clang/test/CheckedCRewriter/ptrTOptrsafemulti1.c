// RUN: cconv-standalone -base-dir=%S -output-postfix=checked %s %S/ptrTOptrsafemulti2.c
//RUN: %clang -c %S/ptrTOptrsafemulti1.checked.c %S/ptrTOptrsafemulti2.checked.c
