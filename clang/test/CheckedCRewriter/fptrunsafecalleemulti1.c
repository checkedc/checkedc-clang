// RUN: cconv-standalone -base-dir=%S -output-postfix=checked %s %S/fptrunsafecalleemulti2.c
//RUN: %clang -c %S/fptrunsafecalleemulti1.checked.c %S/fptrunsafecalleemulti2.checked.c
