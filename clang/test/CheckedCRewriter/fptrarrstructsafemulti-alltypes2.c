// RUN: cconv-standalone -base-dir=%S -alltypes -output-postfix=checked2 %s %S/fptrarrstructsafemulti-alltypes1.c
//RUN: FileCheck -match-full-lines --input-file %S/fptrarrstructsafemulti-alltypes2.checked2.c %s
//RUN: rm %S/fptrarrstructsafemulti-alltypes1.checked2.c %S/fptrarrstructsafemulti-alltypes2.checked2.c
...
/*For robustness, this test is identical to fptrarrstructprotosafe-alltypes.c and fptrarrstructsafe-alltypes.c except in that
