// RUN: cconv-standalone -base-dir=%S -output-postfix=checked %s %S/fptrarrinstructcallermulti2.c
//RUN: %clang -c %S/fptrarrinstructcallermulti1.checked.c %S/fptrarrinstructcallermulti2.checked.c
