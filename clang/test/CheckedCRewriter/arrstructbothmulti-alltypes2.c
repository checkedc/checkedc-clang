// RUN: cconv-standalone -base-dir=%S -alltypes -output-postfix=checked2 %s %S/arrstructbothmulti-alltypes1.c
//RUN: FileCheck -match-full-lines --input-file %S/arrstructbothmulti-alltypes2.checked2.c %s
//RUN: rm %S/arrstructbothmulti-alltypes1.checked2.c %S/arrstructbothmulti-alltypes2.checked2.c
...
/*For robustness, this test is identical to arrstructprotoboth-alltypes.c and arrstructboth-alltypes.c except in that
