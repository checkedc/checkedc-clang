// RUN: cconv-standalone -base-dir=%S -alltypes -output-postfix=checked %s %S/safefptrargcalleemulti-alltypes2.c
//RUN: FileCheck -match-full-lines --input-file %S/safefptrargcalleemulti-alltypes1.checked.c %s
//RUN: rm %S/safefptrargcalleemulti-alltypes1.checked.c %S/safefptrargcalleemulti-alltypes2.checked.c
