// RUN: cconv-standalone -base-dir=%S -output-postfix=checked %s %S/fptrsafecallermulti2.c
//RUN: %clang -c %S/fptrsafecallermulti1.checked.c %S/fptrsafecallermulti2.checked.c
