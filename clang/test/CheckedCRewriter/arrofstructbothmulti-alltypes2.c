// RUN: cconv-standalone -base-dir=%S -alltypes -output-postfix=checked2 %s %S/arrofstructbothmulti-alltypes1.c
//RUN: FileCheck -match-full-lines --input-file %S/arrofstructbothmulti-alltypes2.checked2.c %s
//RUN: rm %S/arrofstructbothmulti-alltypes1.checked2.c %S/arrofstructbothmulti-alltypes2.checked2.c
...
of structs*/
/*For robustness, this test is identical to arrofstructprotoboth-alltypes.c and arrofstructboth-alltypes.c except in that
