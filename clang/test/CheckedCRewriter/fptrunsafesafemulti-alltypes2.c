// RUN: cconv-standalone -base-dir=%S -alltypes -output-postfix=checked2 %s %S/fptrunsafesafemulti-alltypes1.c
//RUN: FileCheck -match-full-lines --input-file %S/fptrunsafesafemulti-alltypes2.checked2.c %s
//RUN: rm %S/fptrunsafesafemulti-alltypes1.checked2.c %S/fptrunsafesafemulti-alltypes2.checked2.c
...
/*For robustness, this test is identical to fptrunsafeprotosafe-alltypes.c and fptrunsafesafe-alltypes.c except in that
