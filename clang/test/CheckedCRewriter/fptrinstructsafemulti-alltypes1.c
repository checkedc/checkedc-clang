// RUN: cconv-standalone -base-dir=%S -alltypes -output-postfix=checked %s %S/fptrinstructsafemulti-alltypes2.c
//RUN: FileCheck -match-full-lines --input-file %S/fptrinstructsafemulti-alltypes1.checked.c %s
//RUN: rm %S/fptrinstructsafemulti-alltypes1.checked.c %S/fptrinstructsafemulti-alltypes2.checked.c
...
/*For robustness, this test is identical to fptrinstructprotosafe-alltypes.c and fptrinstructsafe-alltypes.c except in that
