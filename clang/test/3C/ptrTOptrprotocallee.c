...
// RUN: 3c -base-dir=%t.checked -alltypes %t.checked/ptrTOptrprotocallee.c -- | diff %t.checked/ptrTOptrprotocallee.c -
...
/*For robustness, this test is identical to ptrTOptrcallee.c except in that
