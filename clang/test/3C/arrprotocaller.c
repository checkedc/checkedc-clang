...
// RUN: 3c -base-dir=%t.checked -alltypes %t.checked/arrprotocaller.c -- | diff %t.checked/arrprotocaller.c -
...
/*For robustness, this test is identical to arrcaller.c except in that
