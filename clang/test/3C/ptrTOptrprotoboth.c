...
// RUN: 3c -base-dir=%t.checked -alltypes %t.checked/ptrTOptrprotoboth.c -- | diff %t.checked/ptrTOptrprotoboth.c -
...
/*For robustness, this test is identical to ptrTOptrboth.c except in that
