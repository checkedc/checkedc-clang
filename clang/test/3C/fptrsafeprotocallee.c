...
// RUN: 3c -base-dir=%t.checked -alltypes %t.checked/fptrsafeprotocallee.c -- | diff %t.checked/fptrsafeprotocallee.c -
...
/*For robustness, this test is identical to fptrsafecallee.c except in that
