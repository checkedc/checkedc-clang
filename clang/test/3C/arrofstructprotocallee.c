...
// RUN: 3c -base-dir=%t.checked -alltypes %t.checked/arrofstructprotocallee.c -- | diff %t.checked/arrofstructprotocallee.c -
...
of structs*/
/*For robustness, this test is identical to arrofstructcallee.c except in that
