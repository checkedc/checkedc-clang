...
// RUN: 3c -base-dir=%t.checked -alltypes %t.checked/arrstructprotocallee.c -- | diff %t.checked/arrstructprotocallee.c -
...
/*For robustness, this test is identical to arrstructcallee.c except in that
