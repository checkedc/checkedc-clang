// RUN: 3c -base-dir=%S -addcr -alltypes -output-postfix=checkedALL %s %S/ptrTOptrbothmulti2.c
// RUN: 3c -base-dir=%S -addcr -output-postfix=checkedNOALL %s %S/ptrTOptrbothmulti2.c
...
// RUN: 3c -base-dir=%S -alltypes -output-postfix=checked %S/ptrTOptrbothmulti2.c %s
// RUN: 3c -base-dir=%S -alltypes -output-postfix=convert_again %S/ptrTOptrbothmulti1.checked.c %S/ptrTOptrbothmulti2.checked.c
