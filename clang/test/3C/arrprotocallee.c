...
// RUN: 3c -base-dir=%t.checked -alltypes %t.checked/arrprotocallee.c -- | diff %t.checked/arrprotocallee.c -
...
/*For robustness, this test is identical to arrcallee.c except in that
