// RUN: 3c -base-dir=%S -addcr -alltypes -output-postfix=checkedALL2 %S/safefptrargcallermulti1.c %s
// RUN: 3c -base-dir=%S -addcr -output-postfix=checkedNOALL2 %S/safefptrargcallermulti1.c %s
...
// RUN: 3c -base-dir=%S -alltypes -output-postfix=checked2 %S/safefptrargcallermulti1.c %s
// RUN: 3c -base-dir=%S -alltypes -output-postfix=convert_again %S/safefptrargcallermulti1.checked2.c %S/safefptrargcallermulti2.checked2.c
