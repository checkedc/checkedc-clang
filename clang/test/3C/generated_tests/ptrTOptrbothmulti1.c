// RUN: rm -rf %t*
// RUN: 3c -base-dir=%S -addcr -alltypes -output-dir=%t.checkedALL %s %S/ptrTOptrbothmulti2.c --
// RUN: 3c -base-dir=%S -addcr -output-dir=%t.checkedNOALL %s %S/ptrTOptrbothmulti2.c --
// RUN: %clang -working-directory=%t.checkedNOALL -c ptrTOptrbothmulti1.c ptrTOptrbothmulti2.c
// RUN: FileCheck -match-full-lines -check-prefixes="CHECK_NOALL","CHECK" --input-file %t.checkedNOALL/ptrTOptrbothmulti1.c %s
// RUN: FileCheck -match-full-lines -check-prefixes="CHECK_ALL","CHECK" --input-file %t.checkedALL/ptrTOptrbothmulti1.c %s
// RUN: 3c -base-dir=%S -alltypes -output-dir=%t.checked %S/ptrTOptrbothmulti2.c %s --
...
ptrTOptrprotoboth.c and ptrTOptrboth.c except in that
