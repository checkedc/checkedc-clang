...
// RUN: 3c -base-dir=%t.checked -alltypes %t.checked/fptrarrinstructprotocallee.c -- | diff %t.checked/fptrarrinstructprotocallee.c -
...
fptrarrinstructcallee.c except in that
