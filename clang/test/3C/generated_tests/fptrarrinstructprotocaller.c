...
// RUN: 3c -base-dir=%t.checked -alltypes %t.checked/fptrarrinstructprotocaller.c -- | diff %t.checked/fptrarrinstructprotocaller.c -
...
fptrarrinstructcaller.c except in that
...
struct arrfptr *bar() {
  ...
  struct arrfptr *z = sus(x, y);
  //CHECK_NOALL: struct arrfptr *z = ((struct arrfptr *)sus(x, y));
