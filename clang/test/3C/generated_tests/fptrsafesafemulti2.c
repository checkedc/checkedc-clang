// RUN: rm -rf %t*
// RUN: 3c -base-dir=%S -addcr -alltypes -output-dir=%t.checkedALL2 %S/fptrsafesafemulti1.c %s --
// RUN: 3c -base-dir=%S -addcr -output-dir=%t.checkedNOALL2 %S/fptrsafesafemulti1.c %s --
// RUN: %clang -working-directory=%t.checkedNOALL2 -c fptrsafesafemulti1.c fptrsafesafemulti2.c
// RUN: FileCheck -match-full-lines -check-prefixes="CHECK_NOALL","CHECK" --input-file %t.checkedNOALL2/fptrsafesafemulti2.c %s
// RUN: FileCheck -match-full-lines -check-prefixes="CHECK_ALL","CHECK" --input-file %t.checkedALL2/fptrsafesafemulti2.c %s
// RUN: 3c -base-dir=%S -alltypes -output-dir=%t.checked %S/fptrsafesafemulti1.c %s --
// RUN: 3c -base-dir=%t.checked -alltypes -output-dir=%t.convert_again %t.checked/fptrsafesafemulti1.c %t.checked/fptrsafesafemulti2.c --
// RUN: test ! -f %t.convert_again/fptrsafesafemulti1.c
// RUN: test ! -f %t.convert_again/fptrsafesafemulti2.c
...
fptrsafeprotosafe.c and fptrsafesafe.c except in that
