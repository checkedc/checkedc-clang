// RUN: rm -rf %t*
// RUN: 3c -base-dir=%S -addcr -alltypes -output-dir=%t.checkedALL2 %S/arrstructsafemulti1.c %s --
// RUN: 3c -base-dir=%S -addcr -output-dir=%t.checkedNOALL2 %S/arrstructsafemulti1.c %s --
// RUN: %clang -working-directory=%t.checkedNOALL2 -c arrstructsafemulti1.c arrstructsafemulti2.c
// RUN: FileCheck -match-full-lines -check-prefixes="CHECK_NOALL","CHECK" --input-file %t.checkedNOALL2/arrstructsafemulti2.c %s
// RUN: FileCheck -match-full-lines -check-prefixes="CHECK_ALL","CHECK" --input-file %t.checkedALL2/arrstructsafemulti2.c %s
// RUN: 3c -base-dir=%S -alltypes -output-dir=%t.checked %S/arrstructsafemulti1.c %s --
// RUN: 3c -base-dir=%t.checked -alltypes -output-dir=%t.convert_again %t.checked/arrstructsafemulti1.c %t.checked/arrstructsafemulti2.c --
// RUN: test ! -f %t.convert_again/arrstructsafemulti1.c
// RUN: test ! -f %t.convert_again/arrstructsafemulti2.c
...
arrstructprotosafe.c and arrstructsafe.c except in that
