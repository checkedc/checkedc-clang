...
// RUN: 3c -base-dir=%t.checked -alltypes %t.checked/fptrarrcaller.c -- | diff %t.checked/fptrarrcaller.c -
...
int **bar() {
  ...
  //CHECK_ALL: _Array_ptr<_Ptr<int>> __3c_lower_bound_z : count(5) = sus(x, y);
