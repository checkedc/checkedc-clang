// RUN: rm -rf %t*
// RUN: 3c -base-dir=%S -addcr -alltypes -output-dir=%t.checkedALL2 %S/fptrsafecallermulti1.c %s --
// RUN: 3c -base-dir=%S -addcr -output-dir=%t.checkedNOALL2 %S/fptrsafecallermulti1.c %s --
// RUN: %clang -working-directory=%t.checkedNOALL2 -c fptrsafecallermulti1.c fptrsafecallermulti2.c
// RUN: FileCheck -match-full-lines -check-prefixes="CHECK_NOALL","CHECK" --input-file %t.checkedNOALL2/fptrsafecallermulti2.c %s
// RUN: FileCheck -match-full-lines -check-prefixes="CHECK_ALL","CHECK" --input-file %t.checkedALL2/fptrsafecallermulti2.c %s
// RUN: 3c -base-dir=%S -alltypes -output-dir=%t.checked %S/fptrsafecallermulti1.c %s --
// RUN: 3c -base-dir=%t.checked -alltypes -output-dir=%t.convert_again %t.checked/fptrsafecallermulti1.c %t.checked/fptrsafecallermulti2.c --
// RUN: test ! -f %t.convert_again/fptrsafecallermulti1.c
// RUN: test ! -f %t.convert_again/fptrsafecallermulti2.c
...
fptrsafeprotocaller.c and fptrsafecaller.c except in that
