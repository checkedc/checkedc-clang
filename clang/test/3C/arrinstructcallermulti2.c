// RUN: 3c -base-dir=%S -addcr -alltypes -output-postfix=checkedALL2 %S/arrinstructcallermulti1.c %s
// RUN: 3c -base-dir=%S -addcr -output-postfix=checkedNOALL2 %S/arrinstructcallermulti1.c %s
// RUN: %clang -c %S/arrinstructcallermulti1.checkedNOALL2.c %S/arrinstructcallermulti2.checkedNOALL2.c
// RUN: FileCheck -match-full-lines -check-prefixes="CHECK_NOALL","CHECK" --input-file %S/arrinstructcallermulti2.checkedNOALL2.c %s
// RUN: FileCheck -match-full-lines -check-prefixes="CHECK_ALL","CHECK" --input-file %S/arrinstructcallermulti2.checkedALL2.c %s
// RUN: 3c -base-dir=%S -alltypes -output-postfix=checked2 %S/arrinstructcallermulti1.c %s
// RUN: 3c -base-dir=%S -alltypes -output-postfix=convert_again %S/arrinstructcallermulti1.checked2.c %S/arrinstructcallermulti2.checked2.c
