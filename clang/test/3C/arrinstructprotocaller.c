...
// RUN: 3c -base-dir=%t.checked -alltypes %t.checked/arrinstructprotocaller.c -- | diff %t.checked/arrinstructprotocaller.c -
...
/*For robustness, this test is identical to arrinstructcaller.c except in that
