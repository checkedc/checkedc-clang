...
// RUN: 3c -alltypes %S/unsafefptrargprotocaller.checked.c -- | count 0
// RUN: rm %S/unsafefptrargprotocaller.checked.c
...
/*For robustness, this test is identical to unsafefptrargcaller.c except in that
