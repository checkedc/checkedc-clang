...
// RUN: FileCheck -match-full-lines -check-prefixes="CHECK_NOALL" --input-file %t.checkedNOALL/multidef1b.c %s
// RUN: FileCheck -match-full-lines -check-prefixes="CHECK_ALL" --input-file %t.checkedALL/multidef1b.c %s
