...
// RUN: 3c -base-dir=%t.checked -alltypes %t.checked/fptrarrstructprotocaller.c -- | diff %t.checked/fptrarrstructprotocaller.c -
...
/*For robustness, this test is identical to fptrarrstructcaller.c except in that
