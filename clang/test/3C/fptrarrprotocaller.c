...
// RUN: 3c -base-dir=%t.checked -alltypes %t.checked/fptrarrprotocaller.c -- | diff %t.checked/fptrarrprotocaller.c -
...
/*For robustness, this test is identical to fptrarrcaller.c except in that
