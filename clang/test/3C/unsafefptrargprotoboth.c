...
// RUN: 3c -alltypes %S/unsafefptrargprotoboth.checked.c -- | count 0
// RUN: rm %S/unsafefptrargprotoboth.checked.c
...
/*For robustness, this test is identical to unsafefptrargboth.c except in that
