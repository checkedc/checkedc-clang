// RUN: 3c -base-dir=%S -addcr -alltypes -output-postfix=checkedALL %s %S/fptrarrstructcalleemulti2.c
// RUN: 3c -base-dir=%S -addcr -output-postfix=checkedNOALL %s %S/fptrarrstructcalleemulti2.c
...
// RUN: 3c -base-dir=%S -alltypes -output-postfix=checked %S/fptrarrstructcalleemulti2.c %s
// RUN: 3c -base-dir=%S -alltypes -output-postfix=convert_again %S/fptrarrstructcalleemulti1.checked.c %S/fptrarrstructcalleemulti2.checked.c
