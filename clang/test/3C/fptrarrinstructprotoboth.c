...
// RUN: 3c -base-dir=%t.checked -alltypes %t.checked/fptrarrinstructprotoboth.c -- | diff %t.checked/fptrarrinstructprotoboth.c -
...
/*For robustness, this test is identical to fptrarrinstructboth.c except in that
