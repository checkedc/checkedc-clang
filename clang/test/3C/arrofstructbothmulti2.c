// RUN: 3c -base-dir=%S -addcr -alltypes -output-postfix=checkedALL2 %S/arrofstructbothmulti1.c %s
// RUN: 3c -base-dir=%S -addcr -output-postfix=checkedNOALL2 %S/arrofstructbothmulti1.c %s
...
// RUN: 3c -base-dir=%S -alltypes -output-postfix=checked2 %S/arrofstructbothmulti1.c %s
// RUN: 3c -base-dir=%S -alltypes -output-postfix=convert_again %S/arrofstructbothmulti1.checked2.c %S/arrofstructbothmulti2.checked2.c
