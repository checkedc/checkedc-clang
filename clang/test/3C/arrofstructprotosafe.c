...
// RUN: 3c -base-dir=%t.checked -alltypes %t.checked/arrofstructprotosafe.c -- | diff %t.checked/arrofstructprotosafe.c -
...
of structs*/
/*For robustness, this test is identical to arrofstructsafe.c except in that
