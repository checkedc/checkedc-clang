...
// RUN: 3c -alltypes %S/unsafefptrargprotosafe.checked.c -- | count 0
// RUN: rm %S/unsafefptrargprotosafe.checked.c
...
/*For robustness, this test is identical to unsafefptrargsafe.c except in that
