...
// RUN: 3c -base-dir=%t.checked -alltypes %t.checked/arrstructprotoboth.c -- | diff %t.checked/arrstructprotoboth.c -
...
/*For robustness, this test is identical to arrstructboth.c except in that
