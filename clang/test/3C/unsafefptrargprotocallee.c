...
// RUN: 3c -alltypes %S/unsafefptrargprotocallee.checked.c -- | count 0
// RUN: rm %S/unsafefptrargprotocallee.checked.c
...
/*For robustness, this test is identical to unsafefptrargcallee.c except in that
