// RUN: 3c -base-dir=%S -addcr -alltypes -output-postfix=checkedALL %s %S/ptrTOptrcallermulti2.c
// RUN: 3c -base-dir=%S -addcr -output-postfix=checkedNOALL %s %S/ptrTOptrcallermulti2.c
// RUN: %clang -c %S/ptrTOptrcallermulti1.checkedNOALL.c %S/ptrTOptrcallermulti2.checkedNOALL.c
// RUN: FileCheck -match-full-lines -check-prefixes="CHECK_NOALL","CHECK" --input-file %S/ptrTOptrcallermulti1.checkedNOALL.c %s
// RUN: FileCheck -match-full-lines -check-prefixes="CHECK_ALL","CHECK" --input-file %S/ptrTOptrcallermulti1.checkedALL.c %s
// RUN: 3c -base-dir=%S -alltypes -output-postfix=checked %S/ptrTOptrcallermulti2.c %s
// RUN: 3c -base-dir=%S -alltypes -output-postfix=convert_again %S/ptrTOptrcallermulti1.checked.c %S/ptrTOptrcallermulti2.checked.c
