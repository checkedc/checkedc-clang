...
public:
  ...
  // declaration (D). This constructor call to the next constructor below with
  // QT and N instantiated from the information in D.
  ...
  // IsGeneric: CheckedC support generic types (e.g, _Itype_for_any) which need
  //            less restrictive constraints. Set to true to indicate that this
  //            variable is generic.
