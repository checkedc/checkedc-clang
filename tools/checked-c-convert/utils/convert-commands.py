...
if __name__ == '__main__':
  ...
  parser = argparse.ArgumentParser("runner", description="Tool that converts the compilation commands into"
  ...
  parser.add_argument("-l", '--link', dest='link', action='store_true', default=False,
                      help='Option to enable running on all the files.'
                           'This will enable linking and conversion '
                           'that makes sense across the entire project.')
