...
//
// RUN: CConvertStandalone %s -- -fcheckedc-extension | FileCheck -match-full-lines %s
// RUN: CConvertStandalone %s -- -fcheckedc-extension | %clang_cc1 -verify -fcheckedc-extension -x c -
