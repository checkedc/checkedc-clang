...
// Wrapper for an overload set.
  ...
  public:
    ...
    ExpectedDecl VisitTypeOpaqueDecl(TypeOpaqueDecl *D);
    ExpectedDecl VisitTypeRevealDecl(TypeRevealDecl *D);
...
ExpectedDecl ASTNodeImporter::VisitTypeOpaqueDecl(TypeOpaqueDecl *D) {
    return VisitTypedefNameDecl(D, /*IsAlias=*/false);
}

ExpectedDecl ASTNodeImporter::VisitTypeRevealDecl(TypeRevealDecl *D) {
    return VisitTypedefNameDecl(D, /*IsAlias=*/false);
}
